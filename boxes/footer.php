    ...
    <div class="footer__top">
        <div class="container">
            <div class="footer__top__logo col-xs-100 col-md-38 col-lg-40">
                <a href="#" title="">
                    <img src="webroot/img/logos/logo--slovakiatrend--footer.png" alt="Logo Slovakia Trend" />
                </a>
            </div>
            <div class="footer__top__link hidden-xs hidden-sm col-md-19 col-lg-19">
                <a href="tel:+421850111177" title="+421850111177">
                    <i class="ico ico--tel--footer left"></i>
                    <span>+421 850 111 177</span>
                </a>
            </div>
            <div class="footer__top__link hidden-xs hidden-sm col-md-19 col-lg-19">
                <a href="tel:+421566523195" title="+421566523195">
                    <i class="ico ico--phone left"></i>
                    <span>+421 56 652 3195</span>
                </a>
            </div>
            <div class="footer__top__link footer__top__link--mail hidden-xs hidden-sm col-md-24 col-lg-22">
                <a href="mailto:info@slovakia-trend.sk" title="info@slovakia-trend.sk">
                    <i class="ico ico--atsign--footer left"></i>
                    <span>info@slovakia-trend.sk</span>
                </a>
            </div>
        </div>
    </div>
    <div class="footer__bottom">
        <div class="container">
            <div class="footer__bottom__box col-xs-100 col-sm-35 visible-xs visible-sm">
                ...
                <div class="footer__bottom__box__link">
                    <a href="mailto:info@slovakia-trend.sk" title="info@slovakia-trend.sk" class="footer_mail">
            ...
            <div class="footer__bottom__map col-xs-100 col-sm-30 col-md-24 col-lg-22">
                <a href="#" title="Kontakt" class="link">
