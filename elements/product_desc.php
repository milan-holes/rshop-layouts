<div class="product__info__text col-xs-100 col-sm-65 col-md-55">
    <h2 class="product__info__title">Popis produktu</h2>
    <?= $product['description'] ?>
    <ul class="list list--square">
        <li>výkon: 2,5HP / 1,8kW</li>
        <li>otáčky: 2850 rpm</li>
        <li>nádoba: 25 lit.</li>
        <li>kapacita: 160 L/min</li>
        <li>napätie: 230V/50Hz</li>
        <li>rozmer: 580x255x580 mm</li>
        <li>tlak: 8 bar</li>
