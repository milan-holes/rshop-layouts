<div class="cart__quick">
    <div class="cart__quick__wrapper">
        <div class="cart__quick__text">
            <strong>Pridajte produkt do košíka</strong> podľa názvu, <br class="hidden-cxs">alebo objednávkového čísla:
        </div>
        <form action="add_quick" method="post">
